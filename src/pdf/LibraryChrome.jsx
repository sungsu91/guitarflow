...
export function LibraryHeader({onMenu,onExit}){
 return <><header className="libraryHeader"><button type="button" aria-label="FRETIVA LAB 홈으로" onClick={onExit}><Music size={26}/><strong>FRETIVA LAB</strong></button><button type="button" aria-label="전체 메뉴" onClick={onMenu}><Menu size={22}/><span>메뉴</span></button></header><h1 className="libraryTitle">악보 연습실</h1></>;
}
