...
export function curriculumTemplates({major, connected, penta, blues, pentaIntervals, bluesIntervals}) {
  ...
  return [
    ...
    make('penta-hook','초급','펜타토닉 반복 훅','Pentatonic Hook','펜타토닉','락',68,penta,
      [[0,1,2,1,0,-1],[0,1,3,2,0,-1],[2,3,4,3,2,-1],[2,1,0,1,0,-1],[3,4,5,4,3,-1],[3,2,1,2,3,-1],[2,3,2,1,0,-1],[1,2,1,1,0,0]],breath,
    ...
    make('major-landing','초급','3도로 맺는 팝 프레이즈','Third-tone Pop Phrases','릭','팝',70,major,
      [[0,1,2,4,2],[2,3,4,1,0],[2,3,4,5,4],[4,3,2,1,0],[4,5,6,7,9],[9,8,7,6,4],[4,3,2,1,2],[2,1,0,0,0]],lyrical,
    ...
    make('pop-chord-route','중급','코드톤 포지션 연결 릭','Chord-tone Position Lick','아르페지오','팝',72,connected,
    ...
    make('triad-engine','고급','트라이어드 역방향 엔진','Triad Direction Engine','아르페지오','락',76,connected,
    ...
    make('seventh-weave','고급','메이저7 지그재그 연결','Major Seventh Weave','아르페지오','재즈',76,connected,
