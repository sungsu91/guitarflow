...
export default function useScoreRangeSelection({canvas,enabled,onRangeChange,onSelect,clearRange}){
 ...
 onKeyDownCapture:e=>{if(e.key==='Escape'){gesture.current=null;clearRange();e.preventDefault();e.stopPropagation();}},
 }:{};
}
