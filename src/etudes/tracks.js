...
export const TRACKS = Object.freeze([
 {type:'벤딩',summary:'반음·온음 벤딩에서 릴리스와 복합 프레이즈까지',prerequisite:'도착할 목표음을 먼저 듣고, 여러 손가락으로 줄을 지지합니다.',stages:[['목표음과 벤딩',['bend-target']],['혼합 리듬과 릴리스',['bend-release-mixed']],['벤딩·레가토·슬라이드 연결',['bend-legato-phrase']]]},
  ...
  { type: '아르페지오', summary: '코드를 잡고 베이스·높은 음을 함께 뜯은 뒤 이어가는 분산 반주', prerequisite: '초급은 0–3프렛의 기본 오픈 코드부터 시작합니다. 0은 개방현입니다. 코드표를 미리 잡고, 세로로 겹친 TAB 숫자는 동시에 뜯으세요.',
    stages: [
      ...
      ['C·Am·F·G → Bmaj7·D#m·Emaj7·Em7 코드 이동', ['chord-accompaniment', 'chord-moving-preparation', 'chord-bass-answer','chord-g-alternating','chord-am-triplet','chord-g-triplet']],
      ['익힌 코드 이동 + 독립 베이스 → 동시 뜯기·엇박·리듬 변형', ['chord-sixteenths', 'chord-density', 'chord-melody-response','chord-am-circle','chord-em-offbeat','chord-c-response']],
    ] },
  { type: '해머온', summary: '한 번 피킹한 뒤 높은 음을 왼손으로 내기', prerequisite: '낮은 음을 선명하게 짚고 높은 음을 누를 손가락을 준비하세요.',
    stages: [
      ...
      ['세 음 연속 해머온 → 줄 이동', ['hammer-three', 'hammer-crossing', 'hammer-handoff','hammer-mixed']],
  ...
  { type: '풀오프', summary: '높은 음의 손가락을 떼어 낮은 음으로 연결하기', prerequisite: '도착할 낮은 음을 미리 누르세요. 높은 음만 떼고 낮은 손가락은 유지합니다.',
    stages: [
      ...
      ['세 음 연속 풀오프 → 줄 이동', ['pull-three', 'pull-crossing', 'pull-handoff','pull-mixed']],
  ...
  { type: '슬라이드', summary: '손가락을 줄에 댄 채 다음 프렛에 도착하기', prerequisite: '두 음을 같은 손가락으로 짚습니다. 도착 프렛과 도착 박자를 함께 확인하세요.',
    stages: [
      ...
      ['여러 포지션 연결 → 8분음표 도착 제어', ['slide-path', 'slide-crossing', 'slide-handoff','slide-slur-mixed']],
  ...
  { type: '레가토', summary: '해머온·풀오프를 연결해 적은 피킹으로 이어 연주하기', prerequisite: '해머온·풀오프 초급을 먼저 익히세요. 여기서의 초급은 레가토 입문 단계입니다.',
    stages: [
      ...
      ['세 음 H·P 연결 → 슬라이드가 섞인 프레이즈', ['legato-three', 'legato-phrase', 'legato-handoff','legato-hph-mixed']],
      ['16분음표 H·P → H·P·SL 복합 연결', ['legato-chain', 'legato-drive', 'legato-phrasing','legato-slide-mixed']],
    ] },
]);
