...
export default function useEditorSettings(draft,setDraft,midi){
 ...
 const capo=isFretted(draft.instrument)&&<button type="button" aria-expanded={menu==='capo'} aria-haspopup="dialog" onClick={e=>open('capo',e)}>{draft.capo?`카포 ${draft.capo}`:'카포 없음'} ▾</button>;
