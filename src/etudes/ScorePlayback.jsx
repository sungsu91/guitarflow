...
export default function ScorePlayback({drumAudio,volume=1,score:sourceScore,practiceRange=null,metronomeOnly=false,bpm=sourceScore?.bpm,disabled=false,practice=false,toolbar=false,toolbarTarget=null,compact=false,dock=false,onPosition,controller,startAt={bar:0,event:0},onBpm,onBeforePlay,renderPractice,repeatCount=1,metroOptions={}}) {
  useLanguage();
