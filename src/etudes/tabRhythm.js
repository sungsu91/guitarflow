...
export function rhythmGroups(events,meter=[4,4],{automatic=true}={}) {
 ...
 });if(group.length)groups.push(group);return !automatic&&events.some(e=>e.beamBefore==='join'||e.beamBefore==='break')?overrideBeamGroups(events,groups):groups;
}
