...
const FIRST_DRIVE_PROJECT = {
  ...
  title: "첫 번째 드라이브",
  description: ko["miniChord.a64BarAcousticPopExerciseCombiningOpenChordChangesWithSection"],
  libraryType: "recommended-progression",
  builtIn: true,
  key: "G Major",
  difficulty: ko["miniChord.beginnerToEarlyIntermediate"],
  timeSignature: "4/4",
  barCount: 64,
  slotFormatVersion: 2,
  slotsPerBar: 4,
  ...
  arrangementOverrides: [
    ...
    section("first-drive-section-intro-b", 4, 7, "intro", ko["miniChord.introBuild"], "first-drive-intro-build", false),
    ...
    section("first-drive-section-chorus-extension", 40, 47, "chorus", ko["miniChord.chorusExpansion"], "first-drive-chorus-sustain"),
...
const NIGHT_WALK_PROJECT = {
  ...
  title: "밤 산책",
  description: ko["miniChord.a64BarProjectForTwoBeatChordChangesAndSpaciousMid"],
  libraryType: "recommended-progression",
  builtIn: true,
  key: "A minor",
  difficulty: ko["miniChord.beginnerToEarlyIntermediate"],
  ...
  arrangementOverrides: [
    ...
    section("night-walk-section-intro-b", 4, 7, "intro", ko["miniChord.introBuild"], "night-walk-intro-build", false),
    ...
    section("night-walk-section-chorus-extension", 40, 47, "chorus", ko["miniChord.chorusExpansion"], "night-walk-chorus-sustain"),
...
const WINDOW_AFTERNOON_PROJECT = {
  ...
  title: "창가의 오후",
  description: ko["miniChord.aBright64BarMidTempoPopProgressionForCGAm"],
  libraryType: "recommended-progression",
  builtIn: true,
  key: "C Major",
  difficulty: ko["etudes.beginner"],
  timeSignature: "4/4",
  barCount: 64,
  slotFormatVersion: 2,
  slotsPerBar: 4,
  ...
  arrangementOverrides: [
    ...
    section("window-afternoon-section-intro-b", 4, 7, "intro", ko["miniChord.introBuild"], "window-afternoon-intro-build", false),
    ...
    section("window-afternoon-section-chorus-extension", 40, 47, "chorus", ko["miniChord.chorusExpansion"], "window-afternoon-chorus-sustain"),
...
const WINDOW_LIGHT_PROJECT = {
  ...
  title: "유리창의 불빛",
  description: ko["miniChord.a64BarProgressionForIiVIChangesSeventhChordsWalking"],
  libraryType: "recommended-progression",
  builtIn: true,
  key: "C Major / A minor",
...
const RUN_FORWARD_PROJECT = {
  ...
  title: "달려가자",
  description: ko["miniChord.anUpbeat64BarPopRockProgressionForOpenChordEighthNote"],
  libraryType: "recommended-progression",
  builtIn: true,
  key: "G Major",
  difficulty: ko["miniChord.beginnerToEarlyIntermediate"],
  ...
  arrangementOverrides: [
    ...
    section("run-forward-section-chorus-lift", 40, 47, "chorus", ko["miniChord.chorusExpansion"], "run-forward-chorus-lift"),
