...
export function mount(width){
 ...
 {id:newId(),events:[e(0,'8',{technique:'H',notes:[{id:newId(),string:1,fret:5}]}),e(240,'8',{technique:'P',notes:[{id:newId(),string:1,fret:7}]}),e(480,'8',{technique:'S'}),e(720,'8',{notes:[{id:newId(),string:1,fret:5}]}),e(960,'2',{palmMute:true,vibrato:true,pickStroke:'down'})]},
 ...
 function Harness(){const [view,setView]=React.useState('tab'),[zoom,setZoom]=React.useState(1),[follow,setFollow]=React.useState('fingering'),[rhythm,setRhythm]=React.useState(true),[manual,setManual]=React.useState(true),[position,setPosition]=React.useState(null),[bpm,setBpm]=React.useState(120),[subdivision,setSubdivision]=React.useState(1);
