"""Prepare the JP Resonator player sprite without repainting the artwork.
...
changes only alpha and fully transparent RGB pixels; the resonator colours,
metalwork, geometry, lettering, and texture remain unchanged.
"""
...
def main() -> None:
    ...
    if "A" not in source.getbands():
        raise ValueError("JP Resonator source must contain an alpha channel")
